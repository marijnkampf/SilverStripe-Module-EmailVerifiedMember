...
class EmailVerifiedSecurity extends Extension
{
    ...
    public function VerifyEmailForm()
    {
        return new EmailVerifiedMemberLoginForm(
            $this->owner,
            'verifyEmailSent',
            new FieldList(new EmailField('Email', _t('Member.EMAIL', 'Email'))),
            new FieldList(new FormAction('verifyEmailSent', _t('EmailVerifiedMember.BUTTONSEND', 'Send me the verify email link again'))),
            false
        );
    }
     ...
     */
    public function verifyEmailSent($data = null)
    {
        $member = null;
        if ($data) {
